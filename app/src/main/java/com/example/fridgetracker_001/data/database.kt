...
@Database(entities = [SkladEntity::class, PotravinaEntity::class, CodeEntity::class, SeznamEntity::class, NakupEntity::class, PolozkyEntity::class], version = 47, exportSchema = false)
