...
import cz.filip.fridgetracker_001.data.dao.PolozkyDao
...
@Database(entities = [SkladEntity::class, PotravinaEntity::class, CodeEntity::class, SeznamEntity::class, NakupEntity::class, PolozkyEntity::class], version = 51, exportSchema = false)
